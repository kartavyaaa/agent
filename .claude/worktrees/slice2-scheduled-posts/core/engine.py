...
_SYSTEM_PROMPT = (
    ...
    "and scheduled_for as an absolute UTC ISO datetime (e.g. 2026-07-21T15:30:00Z); "
    "otherwise provide a thoughtful critique covering composition, lighting, subject, and suggestions. "
    "When calling schedule_post, always emit scheduled_for as an absolute UTC ISO timestamp. "
