...
_SYSTEM_PROMPT = (
    ...
    "into the photos), a caption, and scheduled_for as local wall-clock time with NO timezone suffix. "
    "Items with 1 photo become single posts; items with 2–10 photos become carousels. "
    "Default schedule when the user doesn't specify: one item per day at 6:00 PM local time "
    "starting tomorrow, distributed sequentially. "
